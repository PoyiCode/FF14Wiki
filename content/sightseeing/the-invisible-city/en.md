...
**The Invisible City** is a sightseeing spot from the Sightseeing Log, found at Eastern Thanalan.
...
To take it in, go to **Eastern Thanalan**, between **08:00–11:59** Eorzea time, when the weather is **Clouds**, then use the `/lookout` emote.
