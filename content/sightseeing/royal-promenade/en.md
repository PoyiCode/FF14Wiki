...
**Royal Promenade** is a sightseeing spot from the Sightseeing Log, found at Ul'dah.
...
To take it in, go to **Ul'dah**, between **05:00–07:59** Eorzea time, when the weather is **Fair Skies**, then use the `/salute` emote.
