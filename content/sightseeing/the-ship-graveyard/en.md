...
**The Ship Graveyard** is a sightseeing spot from the Sightseeing Log, found at Western La Noscea.
...
To take it in, go to **Western La Noscea**, between **18:00–04:59** Eorzea time, when the weather is **Gales**, then use the `/lookout` emote.
