...
**Little Solace** is a sightseeing spot from the Sightseeing Log, found at East Shroud.
...
To take it in, go to **East Shroud**, between **18:00–04:59** Eorzea time, when the weather is **Clear Skies**, then use the `/lookout` emote.
