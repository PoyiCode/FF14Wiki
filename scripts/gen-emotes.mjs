...
const E = [
  ...
  // 互動 / 表情類
  { slug: 'airquotes', cmd: '/airquotes', mood: 'playful',
    n: ['手指引號', '手指引号', 'エアクオート', 'Air Quotes'],
    d: ['雙手比出引號，表示反諷或「所謂的」。', '双手比出引号，表示反讽或“所谓的”。', '両手で引用符を作り、皮肉や「いわゆる」を示す。', 'Make finger quotes to signal irony or the so-called.'] },
  { slug: 'attention', cmd: '/attention', mood: 'respect',
    n: ['立正', '立正', '気をつけ', 'At Attention'],
    d: ['立正站好，表示恭敬或聽令。', '立正站好，表示恭敬或听令。', '気をつけの姿勢で敬意や従順を示す。', 'Stand at attention in respect or readiness.'] },
  { slug: 'battlestance', cmd: '/battlestance', mood: 'neutral',
    n: ['擺出架式', '摆出架式', '戦闘態勢', 'Battle Stance'],
    d: ['擺出戰鬥架式（純表演，耍帥或開玩笑用）。', '摆出战斗架式（纯表演，耍帅或开玩笑用）。', '戦闘の構えをとる（演技用、ふざけや見栄に）。', 'Strike a battle-ready stance, for show or fun.'] },
  { slug: 'dote', cmd: '/dote', mood: 'positive',
    n: ['寵愛', '宠爱', '愛でる', 'Dote'],
    d: ['一臉寵溺地看著對方，表達疼愛。', '一脸宠溺地看着对方，表达疼爱。', 'うっとりと相手を見て可愛がる。', 'Gaze dotingly at someone with affection.'] },
  { slug: 'fistbump', cmd: '/fistbump', mood: 'positive',
    n: ['碰拳', '碰拳', 'グータッチ', 'Fist Bump'],
    d: ['與對方碰拳，表示哥們情誼或慶祝。', '与对方碰拳，表示哥们情谊或庆祝。', '相手とグータッチして仲間意識や祝福を示す。', 'Bump fists in camaraderie or celebration.'] },
  { slug: 'goodbye', cmd: '/goodbye', mood: 'greeting',
    n: ['道別', '道别', 'さようなら', 'Goodbye'],
    d: ['揮手道別，明確表示要離開。', '挥手道别，明确表示要离开。', '手を振って別れを告げる。', 'Wave farewell, clearly signalling a parting.'] },
  { slug: 'hug', cmd: '/hug', mood: 'positive',
    n: ['擁抱', '拥抱', 'ハグ', 'Hug'],
    d: ['給對方一個擁抱，表達親密或安慰。', '给对方一个拥抱，表达亲密或安慰。', '相手を抱きしめて親しみや慰めを示す。', 'Give a hug to show closeness or comfort.'] },
  { slug: 'thumbsup', cmd: '/thumbsup', mood: 'positive',
    n: ['豎起大拇指', '竖起大拇指', '親指を立てる', 'Thumbs Up'],
    d: ['比讚，表示認可或「沒問題」。', '比赞，表示认可或“没问题”。', '親指を立てて承認や「OK」を示す。', 'Give a thumbs-up to approve or say all is well.'] },
  { slug: 'victory', cmd: '/victory', mood: 'positive',
    n: ['勝利姿勢', '胜利姿势', '勝利のポーズ', 'Victory'],
    d: ['擺出勝利姿勢，表達得意或慶祝。', '摆出胜利姿势，表达得意或庆祝。', '勝利のポーズで誇らしさや祝いを表す。', 'Strike a victory pose in triumph.'] },
  { slug: 'me', cmd: '/me', mood: 'custom',
    n: ['自訂動作', '自定义动作', 'カスタムエモート', 'Custom Emote'],
    d: ['用 `/me 文字` 自訂旁白動作，例如「/me 望向遠方的海」，讓 bot 描述自身行為。', '用 `/me 文字` 自定义旁白动作，例如「/me 望向远方的海」，让 bot 描述自身行为。', '「/me 文章」で自由な動作文を表示。例「/me 遠くの海を見つめる」。botが自らの所作を描写できる。', 'Use `/me text` for a custom action line, e.g. /me gazes out to sea — lets the bot narrate its own actions.'] },

  // 舞蹈類（招牌 emote）
  { slug: 'manderville', cmd: '/manderville', mood: 'playful',
    n: ['曼德維爾之舞', '曼德维尔之舞', 'マンダヴィルダンス', 'Manderville Dance'],
    d: ['招牌搞笑舞步，炒熱氣氛的經典舞蹈。', '招牌搞笑舞步，炒热气氛的经典舞蹈。', 'おなじみの愉快なダンス。場を盛り上げる定番。', 'The iconic goofy dance — a classic crowd-pleaser.'] },
  { slug: 'sundance', cmd: '/sundance', mood: 'playful',
    n: ['太陽之舞', '太阳之舞', 'サンダンス', 'Sundance'],
    d: ['歡快的太陽之舞。', '欢快的太阳之舞。', '陽気なサンダンス。', 'A cheerful sun dance.'] },
  { slug: 'harvestdance', cmd: '/harvestdance', mood: 'playful',
    n: ['豐收之舞', '丰收之舞', '豊穣の舞', 'Harvest Dance'],
    d: ['慶祝豐收的舞蹈。', '庆祝丰收的舞蹈。', '豊穣を祝う踊り。', 'A dance to celebrate the harvest.'] },
  { slug: 'balldance', cmd: '/balldance', mood: 'playful',
    n: ['舞會之舞', '舞会之舞', 'ボールダンス', 'Ball Dance'],
    d: ['優雅的舞會舞步。', '优雅的舞会舞步。', '優雅な舞踏会のダンス。', 'An elegant ballroom dance.'] },
  { slug: 'thavnairiandance', cmd: '/thavnairiandance', mood: 'playful',
    n: ['薩納安之舞', '萨纳安之舞', 'サベネアの舞', 'Thavnairian Dance'],
    d: ['異國風情的薩納安舞蹈。', '异国风情的萨纳安舞蹈。', '異国情緒あふれるサベネアの舞。', 'An exotic Thavnairian dance.'] },
];
